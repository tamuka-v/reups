...
<body>
<header class="w3-container w3-theme header" style="padding:32px">
...
<div class="bg-img">
  <form method="POST" class="w3-card-4">
    <div class="container">
      ...
      <h4 style="color: red;">Incorrect credentials</h4>
...
<footer class="w3-container w3-theme footer" style="padding:10px">
