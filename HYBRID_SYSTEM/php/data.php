...
echo "<p>".$Battery_Meter_var."</p>";
echo "<p>".$Battery_Temperature_var."</p>";
echo "<p>".$CurrentbatV."</p>";
echo "<p>".$CurrentbatT."</p>";

echo "<p>".$Sun_opacity."</p>";
echo "<p>".$Solar_Temp_var."</p>";
echo "<p>".$CurrentsolV."</p>";
echo "<p>".$CurrentsolT."</p>";

echo "<p>".$CurrentwindV."</p>";
echo "<p>".$CurrentwindS."</p>";

echo "<p>".$CurrentAcS."</p>";
echo "<p>".$CurrentBatS."</p>";
echo "<p>".$CurrentPumpS."</p>";
